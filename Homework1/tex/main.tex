...
}
{
    ...
    \begin{table}[H]
        \centering
            ...
            $Poles$ &  Gc &  Gdc\\
            \hline
            1  & 1.0000 + 0.0000i  &    1.0000 + 0.0000i\\ %Repear ad absurdum. Väntar tills vi är säkra på att det är rätt
            \hline
            2   \\
            \hline
            3  \\
	   ...
	   \hline
            \end{tabular}
    \end{table}
    Comparing the two sets poles leads to the conclusion that they are equal.
}
