...
}
{
	...
	\end{equation}
	%Det är svårt att jämföra bilder på Gdc och Gc pzmap då den ena visar kontinuerliga poler och den andra diskreta. Visar värden istället.
    ...
    \begin{table}[H]
        \centering
         ...
         $Poles$ &  $G_c$ &  $G_{dc}$\\
         \hline
         1  & 0.61 $\pm$ 0i  &    0.61 $\pm$ 0i \\ %Repeat ad absurdum. Väntar tills vi är säkra på att det är rätt
         \hline
	 ...
	 \hline
         \end{tabular}
    \end{table}
    Four poles are exactly equal whilst $G_{dc}$ has an additional real pole. This is since AAAAAAAAAA. 
    We thus conclude that their performance are equal.
