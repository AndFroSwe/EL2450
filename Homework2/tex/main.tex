...
}
{
    ...
    \end{equation}
	Plotting the region results in Figure~\ref{fig:NET_stabilityarea}


	\begin{figure}[H]
    		\centering
        	\includegraphics[width=1\linewidth]{../Matlab/HW2_sources_Windows64bit/images/NET_stabilityarea.png}
        	\caption{The stability regions.}
        	\label{fig:NET_stabilityarea}
    \end{figure}	
}
